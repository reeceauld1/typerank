  ...
  return (
    <div className="w-full max-w-sm mx-auto bg-[var(--surface)] border border-[var(--border)] rounded-xl p-8">
      ...
      <p className="text-[var(--text-muted)] text-sm mb-6">
        {mode === 'signup'
          ? 'sign up to track your level, unlock cosmetics and badges, add friends, duel or rank up against them, sync your learn-mode progress, and climb the leaderboard'
          : mode === 'forgot'
