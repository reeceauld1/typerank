...
export const NAME_COLOR_CATALOG: NameColorDef[] = [
  ...
  },
  {
    id: 'amethyst',
    name: 'Amethyst',
    description: 'Reach Amethyst rank.',
    isUnlocked: stats => reachedRank(stats, 'amethyst'),
    progress: stats => ratio(stats.peakElo, rankMinElo('amethyst')),
  ...
  },
  {
    ...
    isUnlocked: stats => reachedRank(stats, 'legend'),
    progress: stats => ratio(stats.peakElo, rankMinElo('legend')),
