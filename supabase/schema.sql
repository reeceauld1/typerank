...
-- Rank-tier reward borders (see the ranked matchmaking section further
-- down) — distinct ids/names from the level-gated ones above so the two
-- reward tracks never collide.
insert into public.border_catalog (id) values
